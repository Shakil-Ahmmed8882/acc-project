  ...
  return (
    <button
      className={classNames(
        ...
        group uppercase  items-center 
        gap-2 rounded-full border relative overflow-hidden 
        hover:bg-[white] text-sm px-3 hover:px-11 hover:md:px-20 flex 
    ...
    >
      ...
      <svg
        ...
        group-hover:translate-x-3 hidden md:grid absolute items-center right-16 transition-all duration-500
        "
      >
        <path
