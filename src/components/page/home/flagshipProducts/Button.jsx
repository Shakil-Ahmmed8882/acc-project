  ...
  return (
    <button
      className={classNames(
        ...
        hover:bg-[#fafafa]  px-32 hover:md:px-16
    ...
    >
      ...
      <svg
        ...
        className="-translate-x-2 hidden md:flex invisible opacity-0 group-hover:visible group-hover:opacity-100 
        group-hover:translate-x-4 absolute  right-16 transition-all duration-500"
      >
        <path
