const HiddenContent = ({ hiddenContent, isHovered }) => {
  ...
  return (
    ...
    >
      ...
      <h2 className={`text-white text-2xl md:text-3xl lg:text-4xl leading-10 `}>{title || "Hello world"}</h2>
      <div className={`text-[#d1d1d1] pt-4 md:text-center leading-6 `}>{description || "This is the description"}</div>
