...
const ProductList = () => {
  const [products, setProducts] = useState([
    {
      ...
      images: [
        "https://example.com/images/womensdress-front.jpg",
        "https://example.com/images/womensdress-back.jpg",
      ],
      productType: "60d5ec49f4860e59e2d81b2b",
      category: "60d5ec49f4860e59e2d81b2f",
    },
  ]);
  ...
  const groupedProducts = products.reduce((acc, product) => {
    ...
    if (!acc[product.productType][product.category]) {
      acc[product.productType][product.category] = [];
    }
    acc[product.productType][product.category].push(product);
    return acc;
  }, {});
      ...
      <div className="p-4">
        {Object.keys(groupedProducts).map((productType) => (
          <div key={productType} className="mb-8">
            ...
            {Object.keys(groupedProducts[productType]).map((category) => (
              <div key={category} className="mb-4">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">
                  Category: {category}
                </h3>
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                  {groupedProducts[productType][category].map((product) => (
                    <div
                      key={product._id}
