...
function NewButton() {
  return (
    <button className="group  cursor-pointer py-[13px] px-10 bg-transparent  rounded-[60px] box-border flex flex-row items-center justify-center max-w-full border-[2px] border-solid border-gold2 hover:bg-gold2/10 hover:box-border hover:border-[2px] hover:border-solid hover:border-gold2/70">
