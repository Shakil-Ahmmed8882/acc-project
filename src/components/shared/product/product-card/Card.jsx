  ...
  return (
    ...
    cursor-pointer text-white">
      ...
      w-full overflow-hidden group ">
        ...
        />
        <div className="absolute inset-0 bg-[#1611048c]
        rounded-lg mix-blend-overlay transition-all
        duration-300 ease-in "></div>

      </div>
      <h3 style={{letterSpacing:2}} className="mt-9 md:mt-6
      uppercase text-lg">{name}</h3>
      <Link href={`/acc-cigars/${_id}`} className='px-9 py-1 md:px-12 text-sm md:py-2 
